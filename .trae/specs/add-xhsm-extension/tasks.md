...
- [ ] Task 5: 实现 SM9 标识基算法模块
  - [ ] SubTask 5.1: 选定并封装纯 Rust SM9 crate（实现阶段确认可用性与审计情况）
  - [ ] SubTask 5.2: 实现主密钥生成、用户私钥抽取
  - [ ] SubTask 5.3: 实现标识加解密与标识签名验签
  - [ ] SubTask 5.4: 编写 PHP 测试验证标识加解密与签名往返
